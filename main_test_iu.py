...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='/mnt/chenlb/iu_ray/images', help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='/mnt/chenlb/iu_ray/iu_annotation_promptmrg_update.json', help='the path to the directory containing the data.')
    ...
    parser.add_argument('--save_dir', type=str, default='results/test/mimic_cxr', help='the patch to save the models.')
