...
class BaseTester(object):
    def __init__(self, model, criterion_cls, metric_ftns, args, device):
        ...
        self.chexbert_metrics = CheXbertMetrics('/home/chenlb/xray_compare_model/PromptMRG/checkpoints/stanford/chexbert/chexbert.pth', args.batch_size, device)
