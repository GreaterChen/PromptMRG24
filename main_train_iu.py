...
def parse_agrs():
    ...
    parser.add_argument('--ann_path', type=str, default='/mnt/chenlb/iu_ray/iu_annotation_promptmrg_update_split.json', help='the path to the directory containing the data.')
